...
func NewTransition(id, from, to string, startTimers, blockingTimers []string, abnormalConditionOnly bool, transitionCosts *float64, transitionDuration *Duration) *Transition {
	return &Transition{
