...
type FRBCInstruction struct {
    ...
    ActuatorID        ID       `json:"actuator_id" description:"ID of the actuator this instruction belongs to"`
    ExecutionTime     time.Time `json:"execution_time" description:"Time when instruction should be executed"`
    ID                ID       `json:"id" description:"ID of the instruction. Must be unique in the scope of the Resource Manager, for at least the duration of the session between Resource Manager and CEM"`
    ...
    OperationMode     ID       `json:"operation_mode" description:"ID of the FRBC.OperationMode that should be activated"`
