...
type FRBCLeakageBehaviour struct {
	Elements    *[]generated.FRBCLeakageBehaviourElement `json:"elements" description:"List of elements that model the leakage behaviour of the buffer. The fill_level_ranges of the elements must be contiguous."`
